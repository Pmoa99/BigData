...
m_name = FOREACH group_movies GENERATE group as movie_id,  movies.movie_name as m_name;

joined = JOIN m_name BY movie_id, movies BY movie_id;
dataset = FOREACH joined GENERATE movies::movie_id , m_name::m_name as SIZE(m_name), movies::movie_name as movie_name;
