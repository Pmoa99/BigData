...
dataset = FOREACH joined GENERATE movies::movie_id , movies::movie_name as movie_name , SIZE(movies::movie_name) as len , avg_ratings::avg_rating as avg_rating;
ordered = ORDER dataset BY len desc;
